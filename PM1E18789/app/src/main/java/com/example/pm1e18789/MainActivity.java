...
public class MainActivity extends AppCompatActivity {
    ...
    EditText nombre_completo, telefono, nota;
    Spinner sppais;
    ImageView foto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nombre_completo = (EditText) findViewById(R.id.txt_nombre_completo);
        telefono = (EditText) findViewById(R.id.txt_telefono);
        nota = (EditText) findViewById(R.id.txt_notas);
        sppais = (Spinner)findViewById(R.id.cmb_pais);
        foto = (ImageView) findViewById(R.id.imageView);

        Button btnGuardarContacto= (Button) findViewById(R.id.btnGuardar);
        btnTomarFoto = (Button) findViewById(R.id.btnTomarFoto);
        Button btnContactoSalvados = (Button)findViewById(R.id.btn_contactos);
    ...
    private void validarDatos() {
        ...
        }else  if (nombre_completo.getText().toString().equals("")){
